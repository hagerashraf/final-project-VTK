...
function Swap() {
    ...
    <button  className='button' onClick = { clickchest } > Chest </button>
    `;
        ...
        for (let i = 0; i < buttons2.length; i++) {
            buttons2[i].addEventListener('click', App2);
        }
    }
...
<table>
  ...
  <button  fontSize="inherit" onClick={clickSkull}>Skull</button>
  `;
        ...
        function updateFlag(e) {
            ...
            widget.set({
                [name]: value }); // can be called on either viewWidget or parentWidget
        ...
        for (let i = 0; i < buttons3.length; i++) {
            buttons3[i].addEventListener('click', widgetRegistration);
        }

        const buttons = document.querySelectorAll('button');
        for (let i = 0; i < buttons.length; i++) {
            buttons[i].addEventListener('click', App);
        }
    ...
    return (
        ...
        <button  className='button' onClick = { clickskull } > skull </button> 
        <button  className='button' onClick = { clickchest } > Chest </button>
